...
class DebitCardTransactionControllerTest extends TestCase
{
    ...
    public function testCustomerCanCreateADebitCardTransaction()
    {
        ...
        $this->assertDatabaseHas('debit_card_transactions', ['debit_card_id' => $debitCard->id, 'amount' => 12568, 'currency_code' => DebitCardTransaction::CURRENCY_SGD]);
    }
    ...
    public function testCustomerCannotCreateADebitCardTransactionToOtherCustomerDebitCard()
    {
        ...
        $this->assertDatabaseMissing('debit_card_transactions', ['debit_card_id' => $debitCard->id, 'amount' => 125687, 'currency_code' => DebitCardTransaction::CURRENCY_SGD]);
    }
